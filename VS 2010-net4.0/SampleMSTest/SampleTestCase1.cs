...
namespace Inflectra.SpiraTest.AddOns.SpiraTestMSTestExtension.SampleMSTest
{
    ...
    public class SampleTestCase1 : MSTestExtensionsTestFixture
    {
        /// <summary>
        /// Test fixture state
        /// </summary>
        ...
        public void SampleTestCase1_SampleFail()
        {
            //Verify the state
        ...
        public void SampleTestCase1_SamplePass()
        {
            //Verify the state
            Assert.AreEqual(2, testFixtureState, "*Real Error*: State not persisted");
        ...
        public void SampleTestCase1_SampleIgnore()
        {
            //Verify the state
            Assert.AreEqual(2, testFixtureState, "*Real Error*: State not persisted");
